...
public static void main(String[] args) {
        ...
        System.out.println("Login attempt 4: " + Login.validateLogin("adminPass", "password123")); // Should return 0 (invalid password)
        System.out.println("Login attempt 5: " + Login.validateLogin("unknownUser", "password123")); // Should return 2 (Admin privilage)
    }
